---
title: "Annotating single cell datasets"
...
`scPred` will train the classifier on the PCA space (again we observe the same pattern, where to avoid the __curse of dimensionality__, we first reduce the dimension of the data and subsequently perform downstream analysis).
